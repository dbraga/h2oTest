...
public class TestCloud {
  ...
  public void init() throws Exception {
    ...
    String[] packageNamesToWeave = { TestCloud.class.getPackage().getName()} ;


    for (String packageName : packageNamesToWeave) {
      Boot.weavePackage(packageName);
    }
    ArrayList<String> l = new ArrayList<String>(Arrays.asList(new String[]{}));
    l.add(0, "-mainClass");
    l.add(1, TestCloud.class.getName());
  ...
  public static void main(String[] args) throws IOException {
    ...
    //new Model2FileBinarySerializer().load(model, modelFile);
